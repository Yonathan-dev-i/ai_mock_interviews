...
👉 **Autenticación**: Regístrate e inicia sesión usando autenticación de contraseña/correo electrónico manejada por Firebase.

👉 **Crear Entrevistas**: Genera fácilmente entrevistas de trabajo con la ayuda de asistentes de voz de Vapi y Google Gemini.

👉 **Obtener retroalimentación de la IA**: Realiza la entrevista con el agente de voz de IA y recibe retroalimentación instantánea basada en tu conversación.

👉 **UI/UX Moderno**: Una interfaz elegante y fácil de usar diseñada para una gran experiencia.

👉 **Página de Entrevista**: Realiza entrevistas impulsadas por IA con retroalimentación en tiempo real y transcripciones detalladas.

👉 **Panel de Control**: Administra y rastrea todas tus entrevistas con fácil navegación.
...
Reemplace los valores de marcador de posición con sus credenciales reales de **[Firebase](https://firebase.google.com/)**, **[Vapi](https://vapi.ai/?utm_source=youtube&utm_medium=video&utm_campaign=jsmastery_recruitingpractice&utm_content=paid_partner&utm_term=recruitingpractice)**.
